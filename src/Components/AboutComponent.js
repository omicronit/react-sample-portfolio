          ...
          <div className="row">
            <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
              <div className="img-thumb wow fadeInLeft" data-wow-delay="0.3s">
                <img className="img-fluid" src="../../assets/img/about/avatar-JohnDoe.jpg" alt="" />
              </div>
            </div> 
            <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
              <div className="profile-wrapper wow fadeInRight" data-wow-delay="0.3s">
                ...
                <div className="about-profile">
                  <ul className="admin-profile">
                    <li><span className="pro-title"> Name </span> <span className="pro-detail">John Doe</span></li>
                ...
                <button onClick={()=> {} } className="btn btn-common"><i className="icon-paper-clip"></i> Download Resume</button>
                <button onClick={()=> {} } className="btn btn-danger"><i className="icon-speech"></i> Contact Me</button>
              </div>
            </div>   
          </div>
        </div>
